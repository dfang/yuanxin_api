...
func main() {
	...
	log.Debugf("APP_DB_USER: %s, APP_DB_PASSWORD: %s, APP_DB_HOST: %s, APP_DB_NAME: %s", os.Getenv("APP_DB_USER"), os.Getenv("APP_DB_PASSWORD"), os.Getenv("APP_DB_HOST"), os.Getenv("APP_DB_NAME"))
